 ...
 * To use this class:
 * <ul>
 * <li>Create an instance of the {@code GVRTouchPadGestureDetector} for your
 * {@link View}
 ...
 * </ul>
 */
public class GVRTouchPadGestureDetector extends Object implements
    ...
    GVRTouchPadGestureDetector.OnTouchPadGestureListener gestureListener;
    GVRTouchPadGestureDetector.OnTouchPadDoubleTapListener doubleTapListener;
    ...
    public interface OnTouchPadGestureListener {
         ...
         * @return true if the event is consumed, else false
         */
        boolean onSwipe(MotionEvent e, GVRTouchPadGestureDetector.SwipeDirection swipeDirection,
    ...
    public GVRTouchPadGestureDetector(
            GVRTouchPadGestureDetector.OnTouchPadGestureListener listener) {
        gestureDetector = new GestureDetector(this);
        gestureListener = listener;

    }

    public GVRTouchPadGestureDetector(Context context,
                                      GVRTouchPadGestureDetector.OnTouchPadGestureListener listener) {
    ...
    public void setOnDoubleTapListener(
            GVRTouchPadGestureDetector.OnTouchPadDoubleTapListener onDoubleTapListener) {
