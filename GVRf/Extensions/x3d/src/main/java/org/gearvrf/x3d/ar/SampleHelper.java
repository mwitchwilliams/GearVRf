...
public class SampleHelper {
    ...
    public GVRSceneObject createQuadPlane(GVRContext gvrContext) {
        ...
        float[] diffuseColor = mat.getDiffuseColor();
        Log.e("X3DDBG", "SampleHelper createQuadPlane diffuse=" +
    ...
    public void initCursorController(GVRContext gvrContext, final ARMain.TouchHandler handler) {
