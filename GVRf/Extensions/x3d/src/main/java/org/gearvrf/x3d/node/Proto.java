...
public class Proto
{
    ...
    public void setMainGVRSceneObject(GVRSceneObject gvrSceneObject) {
        mGVRSceneObject = gvrSceneObject;
    }
    ...
    public void AddField(String accessType, String name, String type, String value) {
        boolean error = false;
        Field field = new Field( name );
        if (accessType.equalsIgnoreCase("inputOnly")) {
            field.mAccessType = ScriptObject.AccessType.INPUT_ONLY;
        } else if (accessType.equalsIgnoreCase("outputOnly")) {
            field.mAccessType = ScriptObject.AccessType.OUTPUT_ONLY;
        } else if (accessType.equalsIgnoreCase("inputOutput")) {
            field.mAccessType = ScriptObject.AccessType.INPUT_OUTPUT;
        } else if (accessType.equalsIgnoreCase("initializeOnly")) {
            field.mAccessType = ScriptObject.AccessType.INITIALIZE_ONLY;
        }
        else {
            Log.e(TAG, "Error, field " + accessType + " not defined.");
            error = true;
        }
